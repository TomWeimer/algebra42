#‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾#
#                      Conversion between linear and cartesian index:                           #
...
Base.@propagate_inbounds function from_cartesian_to_linear(a::AbstractArray, I::Union{AllCartesianIndex{N}, NTuple{N, Int}}) where N
    N == 0 && return 1
...
Base.@propagate_inbounds function from_cartesian_to_linear(dims::Dims, I::Union{AllCartesianIndex{N}, NTuple{N, Int}}) where N
    N == 0 && return 1
...
#‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾#
#                             NDSubArray offset1 and strides:                                   #
#_______________________________________________________________________________________________#
...
# It is the distance between consecutive elements along the fastest-moving dimension (rows in julia/col major )
...
function compute_stride1(parent::AbstractArray, I::NTuple{N,Any}) where N
    ...
    for (d, idx) in enumerate(I)
        ...
        elseif idx isa Base.Slice
        # - index is ':' 
        # ( all the elements in the dimension are selected hence the previous distance does not change further afterwards )
            return s
        else
            throw(ArgumentError("invalid index type $(typeof(idx))"))
        end
...
# It is the linear shift required to map the first element of the view to the corresponding element in the parent array.
...
#‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾#
#                             ReshapedArray42 indices and dimensions:                           #
#_______________________________________________________________________________________________#

# ======== drop_singleton_dimension ============================================================== #
...
# If the first index is a logical mask (a boolean array), convert it into a concrete array of indices using collect.
ensure_indexable(I::Tuple{Base.LogicalIndex, Vararg{Any}}) = (collect(I[1]), ensure_indexable(Base.tail(I))...)
...
# Special case: If the index is an n dimensional array of Cartesian Index, it contributes to n dimensions
...
# ======== Determines if fancy index are not separated =================================================== #

# Example: A[[1, 3, 5], :, 1:3, []] (Are here separated), A[[1, 3, 5], [2,4], 1:3, :] (But not here)
...
# ======== Return the shape when the fancy index are together =================================================== #
...
# Range index
_fshape(sf, d, i, seen::Val{false}, idx::AbstractUnitRange, rest...) = (length(idx), _fshape(sf, d, i + 1, seen, rest...)...)
_fshape(sf, d, i, seen::Val{true}, idx::AbstractUnitRange, rest...)  = (length(idx), _fshape(sf, d, i + 1, seen, rest...)...)

# fancy index: (Add the broadcasted shape S_fancy when encountering the first fancy index)
_fshape(sf, d,  i, seen::Val{false}, idx::AbstractArray, rest...) = (sf..., _fshape(sf, d, i + 1, Val(true), rest...)...)
_fshape(sf, d,  i, seen::Val{true},  idx::AbstractArray, rest...) = _fshape(sf, d,  i + 1, seen, rest...)


# ======== Return the shape when the fancy index are separated =================================================== #
