...
# +
add(a::AbstractNDArray, b::AbstractNDArray) = (println("called father fucker +"); @MyBroadcast a .+ b)
add(a::AbstractNDArray, scalar::Number)     = (println("called father fucker +");@MyBroadcast a .+ scalar)

# -
sub(a::AbstractNDArray, b::AbstractNDArray) =  (println("called father fucker -"); @MyBroadcast a .- b)
sub(a::AbstractNDArray, scalar::Number)     =  (println("called father fucker -"); @MyBroadcast a .- scalar)

# *
prod(a::AbstractNDArray, scalar::Number)    = (println("called father fucker *"); @MyBroadcast a .* scalar)
