...
@propagate_inbounds _getElement(a::NDScalarView) = __getElement(a)
@propagate_inbounds _setElement!(a::NDScalarView, val)  = __setElement!(a, val)
...
@propagate_inbounds _setElement!(a::NDSubArray{T,N}, val, i::Int) where {T,N} = (
