...
_getElement(a::PermutedDimsArray, i::Int)       = _getElement(a, CartesianIndex42(a, i))
_setElement!(a::PermutedDimsArray, val, i::Int) = _setElement!(a, val, CartesianIndex42(a, i))
...
permutedims(parent::AbstractArray, perm) = PermutedDimsArray(parent, perm)
...
function Base.show(io::IO, A::PermutedDimsArray{T, N, perm}) where {T, N, perm}
